...
//        }
//       reset1(transition: transition)
//    }
//    
//    open class func reset1(transition: UIViewAnimationOptions) {
...
//        NotificationCenter.default.addObserver(self, selector: #selector(inputModeDidChange), name: Notification.Name.UITextViewTextDidChange, object: nil)
//    }
//    
